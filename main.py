...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.le_result.setStyleSheet("""
            border: none;
            border-bottom: 2px solid rgba(30, 30, 30, 255);
            padding: 0 8px;
            font-size:24px;
            font-weight: bold;
        """)
        ...
        self.buttons = {}  # Ajout de l'attribut 'buttons'
    ...
    def connect_keyboard_shortcuts(self):
        ...
        QShortcut(QKeySequence(Qt.Key_Return), self, self.compute_result)
        QShortcut(QKeySequence("Backspace"), self, self.remove_last_character)
